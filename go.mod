...
require (
	...
	github.com/stackrox/scanner v0.0.0-20230320080549-581c726c4295 // indirect
...
replace (
	...
	github.com/stackrox/rox => github.com/stackrox/stackrox v0.0.0-20230323083409-e83503a98fb4
